...
#
# Copyright Tom Lechner (tomlechner.com) 2018-2020
#
#
...
bl_info = {
    "name":        "Buildout Building",
    "description": "Create a building from wall and corner blocks with arrays and drivers",
    "author":      "Tom Lechner",
    "version":     (0, 1, 0),
    "blender":     (2, 82, 0),
    "location":    "View 3D > Sidebar > Create > Buildout",
    "warning":     "",  # used for warning icon and text in addons panel
    #"wiki_url":    "https://github.com/tomlechner/blender-stuff",
    "tracker_url": "https://github.com/tomlechner/blender-stuff/issues",
    "category":    "3D View"
    }


class BUILDOUT_PT_panel(bpy.types.Panel):
...
class BUILDOUT_OT_create_walls(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        destructo_obj = None
        if destructo:
            bpy.ops.mesh.primitive_ico_sphere_add(radius=1, enter_editmode=False, location=(top.location[0], top.location[1], offsetz + nz * wallz ))
            destructo_obj = bpy.context.object
            destructo_obj.name = "DestructoBool"
            destructo_obj.display_type = 'BOUNDS'
        ...
        if cornerobject:
            ...
            collection.objects.link(frontrightcorner)
        ...
        #----front left corner
            ...
            collection.objects.link(frontleftcorner)
         ...
         #----back right corner
            ...
            collection.objects.link(backrightcorner)
        ...
        #----back left corner
            ...
            collection.objects.link(backleftcorner)
        ...
        #---------floors
        if floors:
            bpy.ops.mesh.primitive_cube_add(size = 2, enter_editmode=False, location=(0, 0, offsetz ))
...
#classes = ( BUILDOUT_PT_panel, BUILDOUT_OT_create_walls )

def register():
    bpy.utils.register_class(BUILDOUT_PT_panel)
    bpy.utils.register_class(BUILDOUT_OT_create_walls)
...
def unregister():
    bpy.utils.unregister_class(BUILDOUT_OT_create_walls)
    bpy.utils.unregister_class(BUILDOUT_PT_panel)
